    ...
    <div class="my-4 px-6 flex gap-8 justify-between">
        <div class="w-2/5">
            ...
            <div class="space-y-2 leading-6">
                <p> It's the visual side of development. What a designer creates, we convert into a functioning, visible website. </p>
              ...
              <p> The code we write can be viewed and inspected in the web browser, phone or tablet device. </p>
            </div>
            ...
            <ul class="leading-6 text-sm mt-8 bg-slate-700 p-4 bg-opacity-60 rounded-lg space-y-2 list-disc pl-8">
                ...
                <li>  We use frameworks or libraries that are built off of the above languages. VUE, React, Tailwind (uhum Josh, Jerred's favorite - thank you Jerred!)</li>
